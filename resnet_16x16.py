...
# 3. 构建 ResNet34
# =====================
def build_resnet34(num_classes=4):
    model = models.resnet34(pretrained=False)

    # 修改第一层，适配小尺寸
    model.conv1 = nn.Conv2d(
        1, 64, kernel_size=2, stride=1, padding=1, bias=False
    )
...
# =====================
def main():
    train_dataset = RadarDataset(os.path.join(DATA_ROOT, "train"))
    test_dataset = RadarDataset(os.path.join(DATA_ROOT, "test"))
