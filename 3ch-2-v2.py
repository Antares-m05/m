...
class ResNetBackbone(nn.Module):
    def __init__(self):
        ...
        resnet = models.resnet18(pretrained=False)  # 加载训练参数
        ...
        self.Avg = nn.AdaptiveAvgPool2d((3,48))
...
class ResNetWithAttention(nn.Module):
    def __init__(self, emb_dim=128):
        ...
        self.base1.conv1 = nn.Conv2d(1, 64, kernel_size=(1,5), stride=1, padding=1, bias=False)

        self.base2 = ResNetBackbone()
        self.base2.conv1 = nn.Conv2d(1, 64, kernel_size=(2,5), stride=1, padding=1, bias=False)

        self.base3 = ResNetBackbone()
        self.base3.conv1 = nn.Conv2d(1, 64, kernel_size=(5,5), stride=1, padding=1, bias=False)
        ...
        self.fc = nn.Linear(768, emb_dim)  #256为xc第二维
        self.cbam = CBAM(768,4)
...
def train_fsl(model, loader, device):
    ...
    for batch in tqdm(loader, desc="Training"):
        ...
        qx = F.dropout(qx,random.uniform(0.01,0.01))
        logits = model(qx)
...
def main():
    ...
    train_set = RadarDataset(r"E:\yan\外辐射源数据集-雷达学报\RD\test")
    test_set  = RadarDataset(r"E:\yan\外辐射源数据集-雷达学报\RD\train")
