...
class ResNetWithAttention(nn.Module):
    def __init__(self, emb_dim=128):
        ...
        # ========= 融合后注意力 =========
        self.cbam = CBAM(256 * 3, reduction_ratio=8)
...
def main():
    ...
    train_set = RadarDataset(r"E:\yan\rd\种类识别\4tgts\新吴家桥4分类\test")
    test_set  = RadarDataset(r"E:\yan\rd\种类识别\4tgts\新吴家桥4分类\train")
